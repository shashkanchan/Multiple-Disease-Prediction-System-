# -*- coding: utf-8 -*-
"""
Created on Wed June 01 11:53:51 2022
...
diabetes_model = pickle.load(open('D:/ProjectDHPC/savedModels/diabetes_model.sav','rb'))

heart_disease_model = pickle.load(open('D:/ProjectDHPC/savedModels/heart_disease_model.sav','rb'))

parkinsons_model = pickle.load(open('D:/ProjectDHPC/savedModels/parkinsons_model.sav', 'rb'))

breast_cancer_model = pickle.load(open('D:/ProjectDHPC/savedModels/breast_cancer_model.sav', 'rb'))
...
with st.sidebar:
    ...
    selected = option_menu('Multiple Disease Prediction System',
                          ...
                          icons=['activity','heart','person','exclamation-circle'],
                          default_index=0)
...
if (selected == "Breast cancer Prediction"):
    ...
    with col1:
        fractal_dimensions_mean = st.text_input('mean fractal dimensions')
    ...
    if st.button("Breast Cancer Test Result"):
        breastcancer_prediction = breast_cancer_model.predict([[radius_mean, texture_mean, perimeter_mean, area_mean, smoothness_mean, compactness_mean, concavity_mean, concavepoints_mean, symmetry_mean, fractal_dimensions_mean, radius_se, texture_se, perimeter_se, area_se, smoothness_se, compactness_se, concavity_se, concavepoints_se, symmetry_se, fractal_dimension_se, radius_worst, texture_worst, perimeter_worst, area_worst, smoothness_worst, compactness_worst, concavity_worst, concavepoints_worst, symmetry_worst, fractal_dimension_worst]])                          
            
        if (breastcancer_prediction[0] == 1):
          breastcancer_diagnosis = "The person has Cancer"
        else:
          breastcancer_diagnosis = "The person does not have Cancer"
